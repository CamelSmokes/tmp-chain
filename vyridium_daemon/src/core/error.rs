...
pub enum BlockchainError {
    ...
    #[error("Invalid Tx fee, expected at least {}, got {}", format_vyridium(*_0), format_vyridium(*_1))]
    InvalidTxFee(u64, u64),
    #[error("Fees are lower for this TX than the overrided TX, expected at least {}, got {}", format_vyridium(*_0), format_vyridium(*_1))]
    ...
    #[error(
        "Invalid circulating supply, expected {}, got {} coins generated!",
        _0,
        _1
    )]
...
impl From<VerificationError<BlockchainError>> for BlockchainError {
    fn from(value: VerificationError<BlockchainError>) -> Self {
        match value {
            VerificationError::InvalidNonce(expected, got) => {
