use log::trace;
use vyridium_common::{
    block::BlockVersion, difficulty::Difficulty, time::TimestampMillis, varuint::VarUint,
};
...
pub fn calculate_difficulty(
    ...
    match version {
        BlockVersion::V0 => {
            v1::calculate_difficulty(solve_time, previous_difficulty, p, minimum_difficulty)
        } // BlockVersion::V1 => {
          //     v2::calculate_difficulty(solve_time, previous_difficulty, p, minimum_difficulty)
          // }
    }
}
