...
use crate::{
    api::DataElement,
    crypto::elgamal::{
        Ciphertext, CompressedHandle, DecryptHandle, PedersenOpening, PrivateKey, PublicKey, H,
...
/// See [`derive_shared_key`].
pub fn derive_shared_key_from_ct(sk: &PrivateKey, ciphertext: &Ciphertext) -> SharedKey {
