...
use vyridium_common::rpc_server::InternalRpcError;
use vyridium_common::{
    crypto::Hash,
...
pub enum WalletError {
    ...
    #[error("Your wallet don't have enough funds to pay fees: expected {} but have only {}", format_vyridium(*_0), format_vyridium(*_1))]
    ...
    #[error("Invalid fees provided, minimum fees calculated: {}, provided: {}", format_vyridium(*_0), format_vyridium(*_1))]
