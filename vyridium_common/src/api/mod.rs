...
use crate::{
    ...
    transaction::{
        extra_data::UnknownExtraDataFormat, BurnPayload, Reference, SourceCommitment, Transaction,
...
// This is exactly the same as the one in vyridium_common/src/transaction/mod.rs
